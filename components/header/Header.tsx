...
const Header: FC<{}> = () => {
  return (
    <div className={`${style.header} p-3`}>
      <Link href="/">
        <a className={style.header__logo}>Kadzi | Studio</a>
      </Link>
      <div className={style.header__contact}>
        <a href="mailto:contact@kadzi.fr">
          <svg
            className={`${style.instagram} mr-3`}
        ...
        <Link href="https://www.instagram.com/kadzi_beats">
          <a target="blank">
            <svg
