  ...
  return (
    <>
      ...
      <p className="mb-2">
        ...
        internet <a href="https://kadzi.fr">https://kadzi.fr</a> sont :
      </p>
      <h2 className="mb-4 mt-4">Editeur du Site : </h2>
      <p className="mb-2">Mongeot Matteo</p>
      <p className="mb-2">Numéro de SIRET : 8979893070001</p>
      <p className="mb-2">Responsable editorial : Claude Noe</p>
      <p className="mb-2">2 rue de la petite fin, 21410, ANCEY</p>
      <p className="mb-2">Téléphone : 0628510700</p>
      <p className="mb-2">Email : mongeot.matteo@gmail.com</p>
      <p className="mb-2">
        Site Web : <a href="https://kadzi.fr">https://kadzi.fr</a>
      </p>
      <h2 className="mb-4 mt-4">Hébergement :</h2>
      <p className="mb-2">Hébergeur : Google Cloud Platform</p>
      <p className="mb-2">
      ...
      <h2 className="mb-4 mt-4">Développement</h2>
      <p className="mb-2">Mongeot Alex</p>
      <p className="mb-2">Adresse : 2 rue de la petite fin, 21410, ANCEY</p>
      <p className="mb-2">
        Site Web :{" "}
        <a href="https://www.instagram.com/wearestudio99">
          https://www.instagram.com/wearestudio99
        </a>
      </p>
      <h2 className="mb-4 mt-4">Conditions d’utilisation :</h2>
      <p className="mb-2">
        Mongeot Matteo met en œuvre tous les moyens dont elle dispose, pour
      ...
      <p className="mb-2">
        Le site <a href="https://kadzi.fr">https://kadzi.fr</a> peut-être amené
      ...
      <p className="mb-2">
        ...
        internet ou d’autres ressources disponibles sur Internet. Mongeot Matteo
        ne dispose d'aucun moyen pour contrôler les sites en connexion avec ses
        sites internet. ne répond pas de la disponibilité de tels sites et
        ...
        produits ou services qu’ils proposent, ou de tout usage qui peut être
        fait de ces éléments. Les risques liés à cette utilisation incombent
      ...
      <p className="mb-2">
        ...
        l'autorisation expresse et préalable de Mongeot Matteo.
      </p>
      <p className="mb-2">
        Dans l'hypothèse où un utilisateur ou visiteur souhaiterait mettre en
        place un hyperlien en direction d’un des sites internet de Mongeot
        Matteo, il lui appartiendra d'adresser un email accessible sur le site
        afin de formuler sa demande de mise en place d'un hyperlien. Mongeot
        Matteo se réserve le droit d’accepter ou de refuser un hyperlien sans
        avoir à en justifier sa décision.
      </p>
      <h2 className="mb-4 mt-4">Services fournis : </h2>
      <p className="mb-2">
        Mongeot Matteo s’efforce de fournir sur le site https://kadzi.fr des
        informations aussi précises que possible. les renseignements figurant
        sur le site <a href="https://kadzi.fr">https://kadzi.fr</a> ne sont pas
        ...
        https://kadzi.fr sont données à titre indicatif, et sont susceptibles de
      ...
      <p className="mb-2">
        ...
        mongeot.matteo@gmail.com, en décrivant le problème de la manière la plus
        précise possible (page posant problème, type d’ordinateur et de
        navigateur utilisé, …).
      </p>
      <p className="mb-2">
        ...
        site en utilisant un matériel récent, ne contenant pas de virus et avec
      ...
      <p className="mb-2">
        ...
        Internet ne sauraient engager la responsabilité de Mongeot Matteo.
      </p>
      <h2 className="mb-4 mt-4">Propriété intellectuelle :</h2>
      <p className="mb-2">
        Tout le contenu du présent sur le site{" "}
        <a href="https://kadzi.fr">https://kadzi.fr</a>, incluant, de façon non
      ...
      <p className="mb-2">
        ...
        Mongeot Matteo. Cette représentation ou reproduction, par quelque
      ...
      <h2 className="mb-4 mt-4">Déclaration à la CNIL :</h2>
      <p className="mb-2">
      ...
      <h2 className="mb-4 mt-4">Litiges : </h2>
      <p className="mb-2">
        Les présentes conditions du site{" "}
        <a href="https://kadzi.fr">https://kadzi.fr</a> sont régies par les lois
        ...
        exclusive des tribunaux dont dépend le siège social de la société. La
        langue de référence, pour le règlement de contentieux éventuels, est le
        français.
      </p>
      <h2 className="mb-4 mt-4">Données personnelles :</h2>
      <p className="mb-2">
        ...
        <a href="https://kadzi.fr">https://kadzi.fr</a>.
      </p>
      <p className="mb-2">
